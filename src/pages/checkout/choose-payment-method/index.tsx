...
const ViewCheckout = dynamic(() => import('@/views/ChoosePaymentMethod'), {
  suspense: true,
  ssr: false,
})

const Checkout: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
