...
const ViewRequestQuote = dynamic(() => import('@/views/RequestQuote'), {
  suspense: true,
  ssr: false,
})

const RequestQuote: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
