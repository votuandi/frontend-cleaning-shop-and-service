...
const ViewMyQuotation = dynamic(() => import('@/views/MyQuotation'), {
  suspense: true,
  ssr: false,
})

const MyQuotation: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
