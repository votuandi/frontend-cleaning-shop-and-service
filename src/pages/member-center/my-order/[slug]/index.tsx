...
const ViewOrderDetail = dynamic(() => import('@/views/OrderDetail'), {
  suspense: true,
  ssr: false,
})

const OrderDetail: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
