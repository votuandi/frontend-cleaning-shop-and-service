...
const ViewMemberCenter = dynamic(() => import('@/views/MemberCenter'), {
  suspense: true,
  ssr: false,
})

const MemberCenter: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
