...
const ViewMyAddressDetail = dynamic(() => import('@/views/MyAddressDetail'), {
  suspense: true,
  ssr: false,
})

const MyAddressDetail: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
...
MyAddressDetail.getLayout = (page) => {
